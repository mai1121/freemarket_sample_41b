...
# image = item.item_images.new(item_id: 1, image: File.open("#{Rails.root}/public/images/item1_madomagi.jpeg"))
# item.save!
...
# image = item.item_images.new(item_id: 2, image: File.open("#{Rails.root}/public/images/item2_eva.jpeg"))
# item.save!

# item = Item.new(id:3, name: "おやすみプンプン全巻セット", description: "セットでの販売です。", price: 3000, category_id: 534, saler_id: user.id)
# image = item.item_images.new(item_id: 3, image: File.open("#{Rails.root}/public/images/item3_punpun.jpeg"))
# item.save!

# item = Item.new(id:4, name: "100万円の女達全巻セットああああああああああ", description: "ドラマ化した話題作です。", price: 2500, category_id: 534, saler_id: user.id)
# image = item.item_images.new(item_id: 4, image: File.open("#{Rails.root}/public/images/item4_100million.jpeg"))
...
# item = Item.new(id:7, name: "ポロシャツ", description: "女性用のポロシャツです。", size: 1 , status: 1 , delivery_fee_method: 1 , delivery_method: 1 , ships_from: 1 , days_to_ship: 2 ,price: 5500, category_id: 7, brand_id: 24,saler_id: user.id)
# image = item.item_images.new(item_id: 7, image: File.open("#{Rails.root}/public/images/poloshirt.jpeg"))

# item = Item.new(id:8, name: "トレンチコート", description: "女性用のコートです。", size: 2 , status: 1 , delivery_fee_method: 1 , delivery_method: 1 , ships_from: 14 , days_to_ship: 2 ,price: 3000, category_id: 29, brand_id: 21,saler_id: user.id)
# image = item.item_images.new(item_id: 8, image: File.open("#{Rails.root}/public/images/coat.jpeg"))
# item.save!


# item = Item.new(id:9, name: "デニム", description: "女性用のデニムです。", size: 3 , status: 1 , delivery_fee_method: 1 , delivery_method: 2 , ships_from: 21 , days_to_ship: 2 ,price: 250000, category_id: 33, brand_id: 11,saler_id: user.id)
# image = item.item_images.new(item_id: 9, image: File.open("#{Rails.root}/public/images/denim.jpeg"))
# item.save!

# item = Item.new(id:10, name: "ワンピース", description: "女性用のワンピースです。", size: 1 , status: 1 , delivery_fee_method: 1 , delivery_method: 1 , ships_from: 3 , days_to_ship: 1 ,price: 30000, category_id: 53, brand_id: 11,saler_id: user.id)
# image = item.item_images.new(item_id: 10, image: File.open("#{Rails.root}/public/images/one-peace.jpeg"))
# item.save!

# item = Item.new(id:11, name: "バッグ", description: "女性用のバッグです。全然はいりません",  status: 1 , delivery_fee_method: 1 , delivery_method: 2 , ships_from: 2 , days_to_ship: 1 ,price: 2000, category_id: 85, brand_id: 15,saler_id: user.id)
# image = item.item_images.new(item_id: 11, image: File.open("#{Rails.root}/public/images/bag.jpeg"))
# item.save!

item = Item.new(id:12, name: "サンダル", description: "女性用のサンダルです。底が剥がれそうです。助けてください。", size: 1 , status: 1 , delivery_fee_method: 1 , delivery_method: 1 , ships_from: 4 , days_to_ship: 2 ,price: 3000, category_id: 59, saler_id: user.id)
image = item.item_images.new(item_id: 12, image: File.open("#{Rails.root}/public/images/sandaru.jpeg"))
