...
ActiveRecord::Schema.define(version: 20190104122440) do
  ...
  create_table "user_addresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.index ["email"], name: "index_user_addresses_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_user_addresses_on_reset_password_token", unique: true, using: :btree
  end
