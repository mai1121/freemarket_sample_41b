...
describe User do
  describe '#create' do
    ...
    it "is invalid with a phone_number that has less than 10 characters " do
      ...
      user.valid?
      expect(user.errors[:phone_number][1]).to include("is the wrong length")
    end
    ...
    it "is invalid with a credit_card_expiration_month that has less than 2 characters " do
      ...
      user.valid?
      expect(user.errors[:credit_card_expiration_month][1]).to include("is the wrong length")
    end
    ...
    it "is invalid with a credit_card_expiration_year that has less than 2 characters " do
      ...
      user.valid?
      expect(user.errors[:credit_card_expiration_year][1]).to include("is the wrong length")
    end
    ...
    it "is invalid with a postal_code that has less than 6 characters " do
      ...
      user.valid?
      expect(user.errors[:postal_code][1]).to include("is the wrong length")
    end
